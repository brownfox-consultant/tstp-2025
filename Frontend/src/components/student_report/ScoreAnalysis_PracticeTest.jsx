...
// Dummy data for Practice Tests with Total, Correct, Incorrect questions (with subject)
const DUMMY_PRACTICE_DATA_ALL = [
  { Total: 50, Correct: 35, Incorrect: 15, subject: "Math" },
  { Total: 45, Correct: 30, Incorrect: 15, subject: "English" },
  { Total: 60, Correct: 48, Incorrect: 12, subject: "Math" },
  { Total: 40, Correct: 28, Incorrect: 12, subject: "English" },
  { Total: 55, Correct: 42, Incorrect: 13, subject: "Math" },
  { Total: 50, Correct: 38, Incorrect: 12, subject: "English" },
  { Total: 48, Correct: 40, Incorrect: 8, subject: "Math" },
  { Total: 52, Correct: 44, Incorrect: 8, subject: "English" },
  { Total: 45, Correct: 36, Incorrect: 9, subject: "Math" },
  { Total: 60, Correct: 52, Incorrect: 8, subject: "English" },
  { Total: 55, Correct: 48, Incorrect: 7, subject: "Math" },
  { Total: 50, Correct: 45, Incorrect: 5, subject: "English" },
];
...
export default function ScoreAnalysis_PracticeTest({
  ...
  const chartData = useMemo(() => {
    if (selectedSubject === "All") {
      return DUMMY_PRACTICE_DATA_ALL;
    }
    return DUMMY_PRACTICE_DATA_ALL.filter(item => item.subject === selectedSubject);
  }, [selectedSubject]);
