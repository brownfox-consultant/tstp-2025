...
export default function Topic_Wise_Practice() {
  const legendItems = [
    { label: "Info & Ideas", value: 33, color: "#F59403" },
    { label: "Craft & Structure", value: 28, color: "#FFD36A" },
    { label: "Expression", value: 22, color: "#2E2725" },
    { label: "Conventions", value: 17, color: "#805B30" },
  ];
