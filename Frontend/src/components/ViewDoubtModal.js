...
function ViewDoubtModal({
  ...
  // Fetch slots when faculty opens assigned doubt
  useEffect(() => {
    if (
      !open ||
      role !== "faculty" ||
  ...
  const handleSetTimeSlot = () => {
    patchSetTimeSlot(id, {
      scheduled_slot: selectedFacultySlot,
    })
      .then(() => {
        setUpdated(!updated);
  ...
  const handleAddSlot = () => {
    ...
    if (startDateTime.isBefore(dayjs())) {
      Modal.error({
        title: "Invalid slot",
        content: "That start time has already passed.",
      });
  ...
  const handleDeleteSlot = (slotId) => {
    deleteFacultySlot(slotId)
      .then(() => {
        if (selectedFacultySlot === slotId) {
          setSelectedFacultySlot(null);
        }
  ...
  return (
    <>
      ...
      <Button
        ...
        className="flex items-center text-blue-500 hover:bg-blue-50 rounded-md px-2"
        title="Comments"
      >
        Comment
      </Button>
            ...
            <div className="bg-blue-50/50 border border-blue-100 rounded-md p-3">
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex-1">
                  ...
                  <h3 className="text-xs font-bold text-[#0071BC] mb-1.5 uppercase">
                    Assign to Faculty
                  </h3>
            ...
            role === "admin" && (
              <div className="bg-yellow-50 border border-yellow-100 rounded-md p-3 flex items-center justify-between">
                ...
                <div>
                  ...
                  <h3 className="text-xs font-bold text-yellow-700 mb-0.5 uppercase">
                    Current Status
                  </h3>
                  ...
                  {data.scheduled_slot ? (
                    <p className="text-xs text-gray-600 m-0 mt-1">
                      ...
                      <span className="font-bold text-gray-900">
                        ...
                        {dayjs(
                          data.scheduled_slot.date
                        ).format("MMM D, YYYY")}

                        ,{" "}
                        {data.scheduled_slot.start_time}
                        –
                        {data.scheduled_slot.end_time}
                ...
                {facultySlotOptions.length > 0 && (
                  <div className="flex flex-col gap-1 max-h-28 overflow-y-auto">
                    ...
                    {facultySlotOptions.map((s) => (
                      <div
                        key={s.value}
                        className="flex items-center justify-between text-xs text-gray-600 px-2 py-1 bg-white border border-gray-100 rounded"
                      >
          ...
          {["ASSIGNED_TO_FACULTY", "RAISED"].includes(status) &&
            (role === "admin" || role === "faculty") && (
              <div className="mt-1">
                ...
                <h3 className="text-xs font-semibold text-gray-500 mb-1.5 uppercase">
                  Resolution
                </h3>
          ...
          {status === "RESOLVED" && (
            <>
              <div className="bg-green-50/50 border border-green-100 rounded-md p-3">
                ...
                <h3 className="text-xs font-bold text-green-700 mb-1 uppercase">
                  Resolution
                </h3>
